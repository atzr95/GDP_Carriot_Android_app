...
public class SoilGraph extends AppCompatActivity{
    DatabaseHelper myDb;
    LineChart lineChart;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soil_graph);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(SoilGraph.this,d1,c.get(Calendar.YEAR),c.get(Calendar.MONTH),c.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        if(myDb.SoilData().size()!=0) {
            addData();
    ...
    private void addData() {
        ...
        for (int i = 0; i < myDb.SoilData().size(); i++) {
            yVals.add(new Entry(myDb.SoilData().get(i), i));
        }
        LineDataSet dataset = new LineDataSet(yVals, "Soil");
