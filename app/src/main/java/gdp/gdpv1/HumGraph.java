...
public class HumGraph extends AppCompatActivity{
    DatabaseHelper myDb;
    LineChart lineChart;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hum_graph);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(HumGraph.this,d1,c.get(Calendar.YEAR),c.get(Calendar.MONTH),c.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        if(myDb.HumData().size()!=0) {
            addData();
    ...
    private void addData() {
        ...
        for (int i = 0; i < myDb.HumData().size(); i++) {
            yVals.add(new Entry(myDb.HumData().get(i), i));
        }
        LineDataSet dataset = new LineDataSet(yVals, "Humidity");
