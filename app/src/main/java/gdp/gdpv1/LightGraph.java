...
public class LightGraph extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.light_graph);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(LightGraph.this,d1,c.get(Calendar.YEAR),c.get(Calendar.MONTH),c.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        if(myDb.WindData().size()!=0) {
            addData();
    ...
    private void addData() {
        ...
        for (int i = 0; i < myDb.WindData().size(); i++) {
            yVals.add(new Entry(myDb.WindData().get(i), i));
        }
        LineDataSet dataset = new LineDataSet(yVals, "Wind speed");
