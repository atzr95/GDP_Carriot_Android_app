...
public class Graph extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Graph.this,d1,c.get(Calendar.YEAR),c.get(Calendar.MONTH),c.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        if(myDb.TempData().size()!=0) {
            addData();
    ...
    private void addData() {
        ...
        for (int i = 0; i < myDb.TempData().size(); i++) {
            yVals.add(new Entry(myDb.TempData().get(i), i));
        }
        LineDataSet dataset = new LineDataSet(yVals, "Temperature");
        ...
        yAxis.setAxisMaxValue(38f); // the axis maximum is
        yAxis.setAxisMinValue(22f);
